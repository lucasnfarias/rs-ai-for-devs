...
if prompt := st.chat_input("What is up?"):
    ...
    Interaja com o usuário e responda normalmente as perguntas dele, quando ele quiser marcar uma consulta pergunte na ordem.
    1. Qual plano de saúde ele possui
